// 03_basic_shared_memory -- M0+ (CPU2) side, HAL. Compare with
// main_cm0p_bare.c.
//
...
//                           M0+ prints the boot value FOREVER no matter how
//                           many times the M4 toggles the shared integer.
//
...
// COHERENT
uint32_t shared_flag __attribute__((section(".shared"))); //
//          INCOHERENT (demo)
// ===========================================================================
